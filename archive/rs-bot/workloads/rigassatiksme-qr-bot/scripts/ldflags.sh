...
printf '%s' "-X rigassatiksmeqrbot/internal/version.Commit=$commit -X rigassatiksmeqrbot/internal/version.BuildTime=$build_time -X rigassatiksmeqrbot/internal/version.Dirty=$dirty -X rigassatiksmeqrbot/internal/version.ReleaseID=$release_id -X rigassatiksmeqrbot/internal/version.SourceSHA256=$source_sha256"
