...
const translations = {
  ...
  'Atsevišķi no ViVi biļetes reģistrācijas.': ['Separate from ViVi ticket registration.', 'Отдельно от регистрации билета ViVi.'],
  ...
  'Biļetes statuss': ['Ticket status', 'Состояние билета'],
  'Atvērtā biļete': ['Open ticket', 'Открытый билет'],
  'Atrast vai pārslēgt biļeti': ['Find or switch ticket', 'Найти или переключить билет'],
  'Displeja iestatījumi': ['Display settings', 'Настройки экрана'],
  'Pieprasīt kontroles kodu': ['Request inspection code', 'Запросить код проверки'],
  'Izveidot kontroles kodu…': ['Create inspection code…', 'Создать код проверки…'],
  'Reģistrēt atvērto biļeti tagad': ['Register open ticket now', 'Зарегистрировать открытый билет сейчас'],
  ...
  'Atlikušas reģistrācijas: {registrations}; kodi: {codes}.': ['Registrations left: {registrations}; codes: {codes}.', 'Осталось регистраций: {registrations}; кодов: {codes}.'],
  'Kontroles koda cipari': ['Inspection code digits', 'Цифры кода проверки'],
  'Ievadi 2–8 ciparus, tad izveido kodu.': ['Enter 2–8 digits, then create the code.', 'Введите 2–8 цифр, затем создайте код.'],
  ...
  'Starp reģistrācijām jāgaida 30 sekundes. Pieejams {time}.': ['Wait 30 seconds between registrations. Available {time}.', 'Между регистрациями нужно подождать 30 секунд. Доступно {time}.'],
  'Stundas reģistrāciju limits sasniegts. Pieejams {time}.': ['Hourly registration limit reached. Available {time}.', 'Часовой лимит регистраций достигнут. Доступно {time}.'],
  'Kontroles kodu limits sasniegts. Pieejams {time}.': ['Inspection code limit reached. Available {time}.', 'Лимит кодов проверки достигнут. Доступно {time}.'],
