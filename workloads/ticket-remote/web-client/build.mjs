...
const keptBindings = new Set([
  ...["activation_decision", "activation_eligibility", "control_code_fast_state", "control_code_request", "latency_link_v_1", "member_hdr_state", "member_limit_state", "phone_current_report", "relay_current_report", "stream_desired_state", "stream_viewer_focus", "ticket_interaction", "ticket_action_v_3", "ticket_slider_region_v_3"]
    .map((name) => `ticketremote_${name}_table`),
  ...["close_control_code", "confirm_control_code_browser_capture", "recover_stream", "refresh_hdr_state", "refresh_limit_state", "request_control_code", "request_keyframe", "set_hdr_preference", "set_limit_preference", "set_stream_focus", "request_ticket_action_v_3"]
