...
func (s *Server) handlePixelTraceEvent(msg map[string]any) bool {
	...
	for _, key := range []string{
		...
		"frameSequence",
		"sentFrames",
		"lastFreshFrameAgeMillis",
		"phoneUptimeMillis",
		"hardwareH264State",
		"hardwareH264Active",
		"hardwareH264Available",
		"hardwareH264Restarts",
		"hardwareH264LastExitReason",
		"hardwareH264LastFrameAgeMillis",
		"hardwareH264HelperState",
		"hardwareH264Visibility",
		"lastStreamRecoveryResult",
		"lastStreamRecoveryFailureReason",
		"lastStreamRecoveryAgeMillis",
		"streamWatchdogStage",
		"lastStreamWatchdogReason",
		"lastVideoClientAgeMillis",
		"timestampMillis",
	} {
