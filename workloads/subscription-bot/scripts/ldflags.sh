...
printf '%s' "-X subscriptionbot/internal/version.Commit=$commit -X subscriptionbot/internal/version.BuildTime=$build_time -X subscriptionbot/internal/version.Dirty=$dirty -X subscriptionbot/internal/version.ReleaseID=$release_id -X subscriptionbot/internal/version.SourceSHA256=$source_sha256"
