...
printf '%s' "-X satiksmebot/internal/version.Commit=$commit -X satiksmebot/internal/version.BuildTime=$build_time -X satiksmebot/internal/version.Dirty=$dirty -X satiksmebot/internal/version.ReleaseID=$release_id -X satiksmebot/internal/version.SourceSHA256=$source_sha256"
