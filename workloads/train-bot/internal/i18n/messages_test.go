...
func TestWebAppKeysExistInAllLanguages(t *testing.T) {
	keys := []string{
		...
		"app_station_window_title",
		"app_station_window_note",
		"app_station_window_empty",
		"app_incident_area_title",
		"app_incident_platform_sighting",
		"app_incident_platform_sighting_to",
		"app_incident_anonymous",
		"app_public_incidents_vote_cooldown",
		...
		"app_network_map_activity_title",
		"app_network_map_activity_empty",
		"app_network_map_show_all",
