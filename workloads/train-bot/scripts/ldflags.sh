...
printf '%s' "-X telegramtrainapp/internal/version.Commit=$commit -X telegramtrainapp/internal/version.BuildTime=$build_time -X telegramtrainapp/internal/version.Dirty=$dirty -X telegramtrainapp/internal/version.ReleaseID=$release_id -X telegramtrainapp/internal/version.SourceSHA256=$source_sha256"
