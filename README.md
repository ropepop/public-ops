...
- Includes 808 public project file(s) in the sanitized copy.
...
- `security-audit-evidence/`: Public project file or directory included in the sanitized copy.
...
- Risky files removed in the latest sanitation pass: 62
